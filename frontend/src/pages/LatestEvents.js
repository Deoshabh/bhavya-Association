...
import { Calendar, MapPin, Clock, Eye, Heart, MessageCircle, Tag, Search, Filter } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <BackButton />
          <h1 className="text-3xl font-bold text-gray-900 mt-4">Latest News & Events</h1>
          <p className="text-gray-600 mt-2">
            Stay updated with the latest news, events, and announcements from our community
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {news.map((item) => (
              <article key={item._id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
                {item.image?.url && (
