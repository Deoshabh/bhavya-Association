...
import { generateListingMetaTags } from '../utils/sharingImageUtil';
...
const ListingDetails = () => {
  ...
  const DEFAULT_IMAGE = "https://via.placeholder.com/800x600?text=Service+Listing";

  // Use the sharing image utility to generate dynamic meta tags
  const getMetaProps = () => {
    if (!listing) return {};
