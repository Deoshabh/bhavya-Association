            ...
            {category.fields.map((field) => (
              ...
              >
                <div className="flex items-start">
                  <field.icon size={16} className="text-gray-500 group-hover:text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
      ...
      return (
        <div className="p-4 sm:p-8 text-center text-gray-500 h-full flex items-center justify-center">
          <div>
            ...
            <p className="text-sm sm:text-base">Select a field to edit its properties</p>
          </div>
        </div>
      );
    }
              ...
              <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {field.options?.map((option, i) => (
                      <label key={i} className="flex items-center text-sm">
                        <input type="radio" name={field.id} className="mr-2 flex-shrink-0" disabled />
                ...
                {field.type === 'checkbox' && (
                  <div className="space-y-2">
                    {field.options?.map((option, i) => (
                      <label key={i} className="flex items-center text-sm">
                        <input type="checkbox" className="mr-2 flex-shrink-0" disabled />
                        <span className="truncate">{option.label}</span>
                      </label>
                    ))}
                  </div>
          ...
          {formData.fields.length === 0 && (
            <div className="text-center py-8 sm:py-12 text-gray-500">
              ...
              <p className="text-xs sm:text-sm mt-1">
                {window.innerWidth < 1024 ? 'Tap "Add Fields" to get started' : 'Add fields from the toolbox on the left'}
              </p>
            </div>
          )}
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              ...
              <div className="flex items-center justify-center space-x-1 bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`p-2 rounded transition-all ${previewMode === 'desktop' ? 'bg-white shadow' : 'text-gray-600 hover:text-gray-800'}`}
                ...
                <button
                  ...
                  className={`p-2 rounded transition-all ${previewMode === 'tablet' ? 'bg-white shadow' : 'text-gray-600 hover:text-gray-800'}`}
                ...
                <button
                  ...
                  className={`p-2 rounded transition-all ${previewMode === 'mobile' ? 'bg-white shadow' : 'text-gray-600 hover:text-gray-800'}`}
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className={`flex-1 py-2 px-3 text-sm font-medium rounded-lg transition-colors ${
                      mobilePanel === 'toolbox' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                  >
                    Add Fields
                  </button>
                  <button
                    ...
                    className={`flex-1 py-2 px-3 text-sm font-medium rounded-lg transition-colors ${
                      mobilePanel === 'canvas' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                  >
                    Form Builder
                  </button>
                  <button
                    ...
                    className={`flex-1 py-2 px-3 text-sm font-medium rounded-lg transition-colors ${
                      mobilePanel === 'editor' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                  >
                    Properties
                  </button>
